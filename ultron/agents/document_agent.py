...
from ultron.core.base_agent import BaseAgent, AgentTask, AgentResult
from ultron.core.llm_router import router as default_router

logger = logging.getLogger(__name__)

class DocumentAgent(BaseAgent):
    agent_name = "DocumentAgent"
    agent_description = "Corporate Documentation Agent."
