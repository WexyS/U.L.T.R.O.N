...
logger = logging.getLogger("ultron.agents.email_agent")


class EmailAgent(Agent):
    agent_name = "EmailAgent"
    agent_description = "Email Agent — send, receive, and manage emails via IMAP/SMTP."
    ...
    async def _handle_send(self, task: Task) -> TaskResult:
        ...
        body = task.context.get("body", task.input_data)
