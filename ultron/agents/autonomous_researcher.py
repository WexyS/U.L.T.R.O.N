...
from ultron.agents.base import Agent, AgentStatus
from ultron.core.types import Task, TaskResult, TaskStatus
...
class AutonomousWebResearcher(Agent):
    ...
    async def _handle_url_extraction(self, task: Task) -> TaskResult:
        ...
        url = task.context.get("url", task.input_data)
