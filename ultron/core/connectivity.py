...
class ConnectivityManager:
    ...
    def get_offline_recommendation(task_type: str) -> str:
        ...
        recommendations = {
            ...
            "voice": "Voice interaction is operational via local Whisper and optimized edge-engines.",
            "general": "Ultron Genesis is running in local-first mode. All data remains on this machine."
        }
