...
from ultron.core.hermes import HermesExecutionLoop
...
from ultron.agents.vision_agent import UltronVisionAgent
from ultron.agents.architect import AgentArchitect
from ultron.agents.debate_agent import DebateAgent
from ultron.agents.cloner import ClonerAgent
from ultron.agents.whatsapp_agent import WhatsAppAgent
from ultron.agents.gaming_agent import GamingAgent
from ultron.agents.resource_agent import ResourceAgent

# ── AGI Core Modules ──────────────────────────────────────
from ultron.core.reasoning_engine import ReasoningEngine
from ultron.core.planner import Planner
from ultron.core.security import SecurityManager
from ultron.core.self_improvement import SelfImprovementEngine
...
from ultron.core.nexus import UltronNexus
from ultron.core.knowledge import LocalKnowledgeEngine
from ultron.core.context import context_manager
...
from ultron.core.skill_manager import discover_all_skills, discover_all_agents # type: ignore
...
class Orchestrator:
    ...
    async def _execute_research_task(
        ...
        if is_architect and result.status == TaskStatus.SUCCESS and result.context.get("visual_data"):
            ...
            from ultron.workspace.workspace_manager import WorkspaceManager, GenerateRequest
